...
// Source: github.com/ahl5esoft/lite-go/plugin/redisex (interfaces: IRedis)

// Package redisex is a generated GoMock package.
package redisex

import (
	pubsub "github.com/ahl5esoft/lite-go/plugin/pubsub"
...
func (m *MockIRedis) Subscribe(arg0 []string, arg1 chan<- pubsub.Message) {
	m.ctrl.T.Helper()
...
func (m *MockIRedis) Unsubscribe(arg0 ...string) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
...
func (mr *MockIRedisMockRecorder) Unsubscribe(arg0 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Unsubscribe", reflect.TypeOf((*MockIRedis)(nil).Unsubscribe), arg0...)
}
