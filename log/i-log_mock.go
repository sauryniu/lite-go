...
// AddDesc mocks base method
func (m *MockILog) AddDesc(format string, v ...interface{}) ILog {
	m.ctrl.T.Helper()
	varargs := []interface{}{format}
	for _, a := range v {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "AddDesc", varargs...)
	ret0, _ := ret[0].(ILog)
	return ret0
}

// AddDesc indicates an expected call of AddDesc
func (mr *MockILogMockRecorder) AddDesc(format interface{}, v ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{format}, v...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddDesc", reflect.TypeOf((*MockILog)(nil).AddDesc), varargs...)
}
